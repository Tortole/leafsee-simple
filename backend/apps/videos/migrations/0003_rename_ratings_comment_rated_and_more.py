...
import backend.apps.videos.models
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.FileField(
                upload_to=backend.apps.videos.models.generate_video_path
            ),
        ),
        migrations.AlterField(
            model_name="video",
            ...
            field=models.ImageField(
                blank=True, upload_to=backend.apps.videos.models.generate_preview_path
            ),
        ),
        migrations.AlterField(
